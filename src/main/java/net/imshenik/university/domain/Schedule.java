...
public class Schedule implements Serializable {
    ...
    public boolean equals(Object o) {
        ...
        if (teacher != null ? !teacher.equals(schedule.teacher) : schedule.teacher != null)
            return false;
        if (group != null ? !group.equals(schedule.group) : schedule.group != null)
            return false;
        if (classroom != null ? !classroom.equals(schedule.classroom) : schedule.classroom != null)
            return false;
        if (subject != null ? !subject.equals(schedule.subject) : schedule.subject != null)
            return false;
        if (start != null ? !start.equals(schedule.start) : schedule.start != null)
            return false;
